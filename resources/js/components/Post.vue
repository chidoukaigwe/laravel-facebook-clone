<template>
    ...
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-y-hidden">

        <div class="flex flex-col p-4">
            <div class="flex items-center">
                <div class="w-8">
                    <img src="https://chido-designs.co.uk/images/main/Chido.jpg" alt="Profile Image For User" class="w-8 h-8 object-cover rounded-full">
                </div>

                <div class="mx-6">
                    <div class="tex-sm font-bold">Name User</div>
